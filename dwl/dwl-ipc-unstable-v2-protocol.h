...
#define ZDWL_IPC_OUTPUT_V2_FOCUSED_GEOMETRY 10
 ...
 * @ingroup iface_zdwl_ipc_output_v2
 */
#define ZDWL_IPC_OUTPUT_V2_FOCUSED_GEOMETRY_SINCE_VERSION 2
...
/**
 * @ingroup iface_zdwl_ipc_output_v2
 * Sends an focused_geometry event to the client owning the resource.
 * @param resource_ The client's resource
 * @param x X coordinate of the focused client
 * @param y Y coordinate of the focused client
 * @param width Width of the focused client
 * @param height Height of the focused client
 */
static inline void
zdwl_ipc_output_v2_send_focused_geometry(struct wl_resource *resource_, int32_t x, int32_t y, int32_t width, int32_t height)
{
	wl_resource_post_event(resource_, ZDWL_IPC_OUTPUT_V2_FOCUSED_GEOMETRY, x, y, width, height);
}
